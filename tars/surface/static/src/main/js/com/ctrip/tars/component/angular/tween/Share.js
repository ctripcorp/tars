var tweenMenu = angular.module("com.ctrip.tars.tween.share", []).directive("tweenShare", function() {
  return {
    restrict: 'A',
    replace: false,
    transclude: false,
    ...
    link: function(scope, element, attributes, controller) {
      ...
      var $shareButtons = element.find(".share-button"),
        $toggleButton = element.find(".share-toggle-button"),
        menuOpen = false,
